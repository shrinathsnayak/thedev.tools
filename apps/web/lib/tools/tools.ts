...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Get detailed statistics about HTML documents (tags, attributes, size).",
    category: TOOL_CATEGORY_CODE,
  ...
  // ===========================
  {
    ...
    description: "Minify JavaScript to reduce file size and improve load speed.",
    category: TOOL_CATEGORY_CODE,
  ...
  },
  {
    ...
    description: "Get detailed statistics about JavaScript code (functions, variables, size).",
    category: TOOL_CATEGORY_CODE,
  ...
  },
  {
    ...
    description: "Compare two code blocks and visualize differences with highlighting.",
  ...
  },
  {
    ...
    description: "Compare JSON sizes before and after formatting to see compression ratios.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Check color contrast ratios for WCAG accessibility compliance (AA/AAA).",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Calculate and convert aspect ratios, find closest preset ratios.",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Validate Markdown structure, check for syntax errors and warnings.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Extract and generate table of contents from Markdown headers.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Extract all code blocks from Markdown documents with language detection.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Beautify and format Markdown with consistent spacing and structure.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Get detailed statistics about Markdown documents (words, characters, headers, links, etc.).",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Convert text between different case styles (camelCase, PascalCase, snake_case, etc.).",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    slug: "text-analyzer",
    name: "Text Analyzer",
    description: "Analyze text statistics: word count, character count, reading time, and more.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Generate realistic mock data using faker.js with custom schemas and presets.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Convert videos between formats: MP4, WebM, AVI, MOV, MKV, GIF and more.",
  ...
  },
  {
    ...
    description: "Convert audio between formats: MP3, WAV, AAC, OGG, FLAC and more.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    ...
    description: "Convert images between formats: JPEG, PNG, WebP, GIF, BMP and more.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    ...
    description: "Convert HTML content to Markdown format with customizable options.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    slug: "html-to-text",
    name: "HTML to Text",
    description: "Extract plain text from HTML content, stripping all tags and formatting.",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    slug: "image-resizer",
    name: "Image Resizer",
    description: "Resize images client-side without backend. Supports all common formats.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    ...
    description: "Optimize and compress images with format conversion and quality adjustment.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    ...
    description: "Generate harmonious color palettes using color theory (complementary, triadic, etc.).",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Get suggested font pairings for headings and body text with CSS examples.",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Generate CSS keyframe animations and transitions (fade, slide, bounce, etc.).",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Generate .env files with templates for Node.js, Next.js, React, and more.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Generate package.json files with templates for various project types.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Generate Git commands interactively (clone, commit, push, branch, etc.).",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Generate Docker and docker-compose commands with all options.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Comprehensive reference guide for all HTTP status codes with use cases.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Validate HTML for semantic correctness and accessibility best practices.",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    slug: "aria-generator",
    name: "ARIA Generator",
    description: "Generate ARIA attributes for improved accessibility with validation.",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Generate placeholder text in multiple styles (Latin, Bacon, Cat, Pirate, Hipster).",
    category: TOOL_CATEGORY_CONTENT,
  ...
  },
  {
    ...
    description: "Format code snippets for GitHub, Gist, Pastebin, and more with syntax highlighting.",
    category: TOOL_CATEGORY_CODE,
  ...
  },
  {
    ...
    description: "Convert JSON arrays to SQL INSERT statements with batching and options.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Format webhook payloads as cURL, fetch, or axios code with validation.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Format API responses in standard, minimal, or verbose styles (JSON, XML, YAML).",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Query and manipulate JSON with JSONPath expressions and examples.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    slug: "hash-generator",
    name: "Hash Generator",
    description: "Generate MD5, SHA1, SHA256, SHA512 and other cryptographic hashes.",
    category: TOOL_CATEGORY_SECURITY,
  ...
  },
  {
    ...
    description: "Generate secure random passwords with customizable options (length, characters, symbols).",
    category: TOOL_CATEGORY_SECURITY,
  ...
  },
  {
    ...
    description: "Generate Content Security Policy headers with customizable directives for security.",
    category: TOOL_CATEGORY_SECURITY,
  ...
  },
  {
    ...
    description: "Encode and decode HTML entities to prevent XSS attacks and ensure safe HTML rendering.",
    category: TOOL_CATEGORY_SECURITY,
  ...
  },
  {
    ...
    description: "Encode or decode URLs safely to prevent injection attacks and ensure proper URL handling.",
    category: TOOL_CATEGORY_SECURITY,
  ...
  // ===========================
  {
    slug: "docx-to-html",
    name: "DOCX to HTML",
    description: "Convert Word documents (DOCX) to HTML format with formatting preservation.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    slug: "text-to-pdf",
    name: "Text to PDF",
    description: "Convert plain text to PDF with customizable font and layout options.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    slug: "pdf-to-text",
    name: "PDF to Text",
    description: "Extract text content from PDF files with page-by-page extraction.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  },
  {
    slug: "docx-to-pdf",
    name: "DOCX to PDF",
    description: "Convert Word documents (DOCX) to PDF format. Note: Complex formatting may not be perfectly preserved.",
    category: TOOL_CATEGORY_MULTIMEDIA,
  ...
  // ===========================
  {
    ...
    description: "Convert timestamps between timezones with UTC offset calculations.",
  ...
  },
  {
    ...
    description: "Visual builder for cron expressions with validation and preview.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Calculate differences between dates and format durations (ISO 8601, human-readable).",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Generate date ranges, sequences, and intervals for testing and data generation.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Calculate next version (major/minor/patch), compare versions, and check version ranges.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Generate conventional commit messages with templates for consistent commits.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Generate CHANGELOG.md from git commits or manual input (Keep a Changelog format).",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Generate README.md files with templates for various project types.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Generate license files (MIT, Apache, GPL, BSD, ISC, etc.) with customization.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  },
  {
    ...
    description: "Analyze package.json dependencies, find duplicates, and validate versions.",
    category: TOOL_CATEGORY_WORKFLOW,
  ...
  // ===========================
  {
    ...
    description: "Build SELECT, INSERT, UPDATE, DELETE queries with WHERE, JOIN, ORDER BY, etc.",
  ...
  },
  {
    ...
    description: "Escape SQL strings to prevent injection, unescape escaped strings.",
    category: TOOL_CATEGORY_DATABASE,
  ...
  },
  {
    ...
    description: "Parse and validate database connection strings (PostgreSQL, MySQL, MongoDB, etc.).",
    category: TOOL_CATEGORY_DATABASE,
  ...
  },
  {
    ...
    description: "Validate Kubernetes manifests (Deployment, Service, ConfigMap, etc.).",
    category: TOOL_CATEGORY_INFRASTRUCTURE,
  ...
  },
  {
    ...
    description: "Validate .env files for common issues, duplicate keys, and format.",
    category: TOOL_CATEGORY_INFRASTRUCTURE,
  ...
  },
  {
    ...
    description: "Generate code for fetch, axios, node-fetch, cURL, HTTPie, Python requests, Go HTTP.",
    category: TOOL_CATEGORY_API,
  ...
  },
  {
    ...
    description: "Build and validate HTTP headers with common presets and generate cURL/fetch code.",
    category: TOOL_CATEGORY_API,
  ...
  },
  {
    ...
    description: "Parse, edit, and generate Set-Cookie headers with validation.",
    category: TOOL_CATEGORY_API,
  ...
  },
  {
    ...
    description: "Parse, build, validate, and manipulate URLs with query parameter management.",
    category: TOOL_CATEGORY_API,
  ...
  },
  {
    slug: "hmac-generator",
    name: "HMAC Generator",
    description: "Generate HMAC signatures for various algorithms (SHA256, SHA512, etc.).",
    category: TOOL_CATEGORY_API,
  ...
  },
  {
    slug: "jwt-builder",
    name: "JWT Builder",
    description: "Build and sign JWT tokens with custom claims (complement to JWT Decoder).",
    category: TOOL_CATEGORY_API,
  ...
  // ===========================
  {
    ...
    description: "Parse IP addresses, check if private/public, validate CIDR notation.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Generate TypeScript interfaces/types from JSON objects or schemas.",
    category: TOOL_CATEGORY_UTILITIES,
  ...
  },
  {
    ...
    description: "Calculate LOC, comment ratio, function count, complexity metrics.",
    category: TOOL_CATEGORY_CODE,
  ...
  },
  {
    ...
    description: "Generate React, Vue, Svelte, Angular, HTML component boilerplate.",
    category: TOOL_CATEGORY_FRONTEND,
  ...
  },
  {
    ...
    description: "Generate API route handlers for Next.js, Express, Fastify, Koa, Hapi.",
    category: TOOL_CATEGORY_BACKEND,
  ...
  },
  {
    ...
    description: "Format, beautify, minify, and validate JavaScript/TypeScript code. Convert between ESM and CommonJS.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Format, validate, and convert .env files. Sort variables, remove duplicates, validate syntax.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Format and validate INI and Properties files. Convert between INI and JSON formats.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Format, validate, and analyze package.json files. Sort dependencies, validate structure.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Format and validate .gitignore files. Sort patterns, remove duplicates, generate templates.",
    category: TOOL_CATEGORY_FORMATTERS,
  ...
  },
  {
    ...
    description: "Check feature support across browsers using static compatibility data.",
    category: TOOL_CATEGORY_FRONTEND,
